                  ...
                  <table class="table table-bordered table-dark" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th></th>
                        <th>
                          <a href="view-schedule-all.php" type="submit" class="btn btn-primary">View all </a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class='<?php echo $class?>' style="width: 10%;">
                          ...
                          <?php 
                            if ($value['schedule_status_id'] == 2 && $moderator == 1 || $moderator == 4) {
